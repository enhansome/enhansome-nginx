...
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,371 | 🐛 502 | 🌐 C | 📅 2026-09-07
* [Angie](https://github.com/webserver-llc/angie) ⭐ 2,573 | 🐛 44 | 🌐 C | 📅 2026-09-18
...
* [lua](https://github.com/openresty/lua-nginx-module) ⭐ 11,782 | 🐛 396 | 🌐 C | 📅 2026-09-17
...
* [ngx-rust](https://github.com/nginxinc/ngx-rust) ⭐ 915 | 🐛 47 | 🌐 Rust | 📅 2026-09-18 - Rust bindings for Nginx modules.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,202 | 🐛 877 | 🌐 TypeScript | 📅 2026-09-21 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.

* [nginxconfig.io](https://nginxconfig.io) - [GitHub](https://github.com/valentinxxx/nginxconfig.io) ⭐ 28,253 | 🐛 71 | 🌐 JavaScript | 📅 2024-12-14 - Online nginx configuration generator for general purposes.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,995 | 🐛 153 | 🌐 Python | 📅 2026-09-22 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,351 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-22 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 226 | 🐛 5 | 🌐 Dockerfile | 📅 2026-09-22 - Latest Nginx with LuaJIT on six base distros (Alma, Alpine, Amazon, Debian, Fedora, Ubuntu).
