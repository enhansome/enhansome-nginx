...
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,358 | 🐛 501 | 🌐 C | 📅 2026-09-07
...
* [nginx-module-vts](https://github.com/vozlt/nginx-module-vts) ⭐ 3,499 | 🐛 12 | 🌐 C | 📅 2026-09-02 - Nginx virtual host traffic status module.
...
* [nginx\_http\_push\_module](https://github.com/slact/nginx_http_push_module) ⭐ 3,066 | 🐛 134 | 🌐 C | 📅 2026-06-09 - Turn NGiNX into an adept HTTP push server.
...
* [nginx\_modSecurity](https://github.com/SpiderLabs/ModSecurity-nginx) ⭐ 1,856 | 🐛 69 | 🌐 Perl | 📅 2026-05-04 - ModSecurity is an open source, cross platform web application firewall (WAF) engine for Apache, IIS and Nginx that is developed by Trustwave's SpiderLabs.
...
* [ngx-rust](https://github.com/nginxinc/ngx-rust) ⭐ 912 | 🐛 47 | 🌐 Rust | 📅 2026-09-11 - Rust bindings for Nginx modules.
...
* [nginx-lua-waf-kit](https://github.com/fabiocicerchia/nginx-lua-waf-kit) ⭐ 1 | 🐛 2 | 🌐 Lua | 📅 2026-09-10 - Opt-in Lua WAF modules for nginx-lua: rate limiting, bot scoring, edge JWT, geo/ASN policy, mirroring.
...
* [nginx-s3-gateway](https://github.com/nginxinc/nginx-s3-gateway) ⭐ 751 | 🐛 11 | 🌐 Shell | 📅 2026-09-11 - S3 gateway for Nginx allowing to proxy requests directly to S3 private buckets.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,119 | 🐛 884 | 🌐 TypeScript | 📅 2026-09-09 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.

* [nginxconfig.io](https://nginxconfig.io) - [GitHub](https://github.com/valentinxxx/nginxconfig.io) ⭐ 28,260 | 🐛 71 | 🌐 JavaScript | 📅 2024-12-14 - Online nginx configuration generator for general purposes.

* [nginx-proxy](https://github.com/nginx-proxy/nginx-proxy) ⭐ 19,912 | 🐛 326 | 🌐 Python | 📅 2026-09-03 - Automated nginx proxy for Docker containers using docker-gen.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,935 | 🐛 169 | 🌐 Python | 📅 2026-09-11 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,330 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-11 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [nginx-opentracing](https://github.com/opentracing-contrib/nginx-opentracing) ⭐ 515 | 🐛 40 | 🌐 C++ | 📅 2026-09-11 - NGINX plugin for OpenTracing.
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 7 | 🌐 Dockerfile | 📅 2026-09-11 - Latest Nginx with LuaJIT on six base distros (Alma, Alpine, Amazon, Debian, Fedora, Ubuntu).
