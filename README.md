...
* [OpenResty](https://github.com/openresty/ngx_openresty) ⭐ 14,007 | 🐛 332 | 🌐 C | 📅 2026-08-14
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,337 | 🐛 501 | 🌐 C | 📅 2026-08-18
* [Angie](https://github.com/webserver-llc/angie) ⭐ 2,549 | 🐛 45 | 🌐 C | 📅 2026-08-14
...
* [nginx-rtmp-module](https://github.com/arut/nginx-rtmp-module) ⭐ 14,034 | 🐛 1,160 | 🌐 C | 📅 2024-12-24 - NGINX-based Media Streaming Server.
* [ngx\_openresty](https://github.com/openresty/ngx_openresty) ⭐ 14,007 | 🐛 332 | 🌐 C | 📅 2026-08-14 - Turning Nginx into a Full-fledged Web App Server.
...
* [nginx-http-flv-module](https://github.com/winshining/nginx-http-flv-module) ⭐ 2,934 | 🐛 26 | 🌐 C | 📅 2026-08-19  - A media streaming server based on nginx-rtmp-module, provides HTTP-FLV.
...
* [nginx\_modSecurity](https://github.com/SpiderLabs/ModSecurity-nginx) ⭐ 1,848 | 🐛 69 | 🌐 Perl | 📅 2026-05-04 - ModSecurity is an open source, cross platform web application firewall (WAF) engine for Apache, IIS and Nginx that is developed by Trustwave's SpiderLabs.
...
* [nginx-zstd-module](https://github.com/myguard-labs/nginx-zstd-module) ⭐ 27 | 🐛 5 | 🌐 Python | 📅 2026-08-22 - Zstandard (zstd) compression and decompression filters for nginx responses.
...
* [nginx-cache-turbo-module](https://github.com/myguard-labs/nginx-cache-turbo-module) ⭐ 3 | 🐛 0 | 🌐 C | 📅 2026-08-23 - Built-in full-page cache for nginx — a tiny Varnish living inside the worker.
...
* [nginx-s3-gateway](https://github.com/nginxinc/nginx-s3-gateway) ⭐ 745 | 🐛 16 | 🌐 Shell | 📅 2026-08-23 - S3 gateway for Nginx allowing to proxy requests directly to S3 private buckets.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 33,943 | 🐛 913 | 🌐 TypeScript | 📅 2026-08-22 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.
...
* [nginx-proxy](https://github.com/nginx-proxy/nginx-proxy) ⭐ 19,899 | 🐛 323 | 🌐 Python | 📅 2026-08-10 - Automated nginx proxy for Docker containers using docker-gen.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,846 | 🐛 183 | 🌐 Python | 📅 2026-08-21 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,286 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-23 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [nginx-build](https://github.com/cubicdaiya/nginx-build) ⭐ 427 | 🐛 8 | 🌐 Go | 📅 2026-08-23 - seamless nginx builder.
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 20 | 🌐 Dockerfile | 📅 2026-08-23 - Nginx 1.19+ with LUA support based on Alpine Linux, Amazon Linux, CentOS, Debian, Fedora and Ubuntu.
...
* [Nginx book](https://github.com/taobao/nginx-book) ⭐ 6,962 | 🐛 542 | 🌐 Python | 📅 2023-11-20 - Nginx from primer to expert (In Chinese).
