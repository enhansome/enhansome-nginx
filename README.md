...
* [OpenResty](https://github.com/openresty/ngx_openresty) ⭐ 14,028 | 🐛 335 | 🌐 C | 📅 2026-09-02
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,350 | 🐛 501 | 🌐 C | 📅 2026-09-07
...
* [lua](https://github.com/openresty/lua-nginx-module) ⭐ 11,789 | 🐛 395 | 🌐 C | 📅 2026-09-07
...
* [ngx\_openresty](https://github.com/openresty/ngx_openresty) ⭐ 14,028 | 🐛 335 | 🌐 C | 📅 2026-09-02 - Turning Nginx into a Full-fledged Web App Server.
...
* [nginx-autocert-module](https://github.com/myguard-labs/nginx-autocert-module) ⭐ 6 | 🐛 1 | 🌐 C | 📅 2026-09-07 - Automatic TLS certificates built into nginx — ACME/Let's Encrypt issuance and renewal, with wildcard, IP-address certs and TLS-ALPN-01.
...
* [nginx-cache-turbo-module](https://github.com/myguard-labs/nginx-cache-turbo-module) ⭐ 3 | 🐛 0 | 🌐 C | 📅 2026-09-07 - Built-in full-page cache for nginx — a tiny Varnish living inside the worker.
...
* [ngx-rust](https://github.com/nginxinc/ngx-rust) ⭐ 911 | 🐛 47 | 🌐 Rust | 📅 2026-09-04 - Rust bindings for Nginx modules.
...
* [nginx-lua-waf-kit](https://github.com/fabiocicerchia/nginx-lua-waf-kit) ⭐ 1 | 🐛 2 | 🌐 Lua | 📅 2026-09-07 - Opt-in Lua WAF modules for nginx-lua: rate limiting, bot scoring, edge JWT, geo/ASN policy, mirroring.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,088 | 🐛 896 | 🌐 TypeScript | 📅 2026-09-07 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,914 | 🐛 169 | 🌐 Python | 📅 2026-09-07 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,324 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-07 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 11 | 🌐 Dockerfile | 📅 2026-09-07 - Latest Nginx with LuaJIT on six base distros (Alma, Alpine, Amazon, Debian, Fedora, Ubuntu).
