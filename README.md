...
* [OpenResty](https://github.com/openresty/ngx_openresty) ⭐ 14,008 | 🐛 332 | 🌐 C | 📅 2026-08-24
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,337 | 🐛 501 | 🌐 C | 📅 2026-08-24
* [Angie](https://github.com/webserver-llc/angie) ⭐ 2,549 | 🐛 44 | 🌐 C | 📅 2026-08-14
...
* [ngx\_openresty](https://github.com/openresty/ngx_openresty) ⭐ 14,008 | 🐛 332 | 🌐 C | 📅 2026-08-24 - Turning Nginx into a Full-fledged Web App Server.
...
* [nginx-zstd-module](https://github.com/myguard-labs/nginx-zstd-module) ⭐ 27 | 🐛 5 | 🌐 Python | 📅 2026-08-24 - Zstandard (zstd) compression and decompression filters for nginx responses.
...
* [nginx-cache-turbo-module](https://github.com/myguard-labs/nginx-cache-turbo-module) ⭐ 3 | 🐛 0 | 🌐 C | 📅 2026-08-24 - Built-in full-page cache for nginx — a tiny Varnish living inside the worker.
...
* [nginx-s3-gateway](https://github.com/nginxinc/nginx-s3-gateway) ⭐ 747 | 🐛 15 | 🌐 Shell | 📅 2026-08-24 - S3 gateway for Nginx allowing to proxy requests directly to S3 private buckets.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 33,950 | 🐛 906 | 🌐 TypeScript | 📅 2026-08-22 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.
...
* [Laradock](https://github.com/laradock/laradock) ⭐ 12,670 | 🐛 16 | 🌐 Dockerfile | 📅 2026-08-16 - Full PHP development environment based on Docker, includes Nginx as one of its swappable services.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,852 | 🐛 162 | 🌐 Python | 📅 2026-08-24 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,288 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-24 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [nginx-build](https://github.com/cubicdaiya/nginx-build) ⭐ 427 | 🐛 9 | 🌐 Go | 📅 2026-08-23 - seamless nginx builder.
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 17 | 🌐 Dockerfile | 📅 2026-08-24 - Nginx 1.19+ with LUA support based on Alpine Linux, Amazon Linux, CentOS, Debian, Fedora and Ubuntu.
