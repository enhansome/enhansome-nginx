...
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,362 | 🐛 501 | 🌐 C | 📅 2026-09-07
...
* [nginx-zstd-module](https://github.com/myguard-labs/nginx-zstd-module) ⭐ 32 | 🐛 2 | 🌐 C | 📅 2026-09-15 - Zstandard (zstd) compression and decompression filters for nginx responses.
...
* [ngx-rust](https://github.com/nginxinc/ngx-rust) ⭐ 914 | 🐛 47 | 🌐 Rust | 📅 2026-09-15 - Rust bindings for Nginx modules.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,139 | 🐛 878 | 🌐 TypeScript | 📅 2026-09-14 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.
...
* [Laradock](https://github.com/laradock/laradock) ⭐ 12,673 | 🐛 23 | 🌐 Dockerfile | 📅 2026-09-10 - Full PHP development environment based on Docker, includes Nginx as one of its swappable services.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,955 | 🐛 167 | 🌐 Python | 📅 2026-09-15 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,339 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-14 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [nginx-opentracing](https://github.com/opentracing-contrib/nginx-opentracing) ⭐ 514 | 🐛 39 | 🌐 C++ | 📅 2026-09-14 - NGINX plugin for OpenTracing.
...
* [nginx-build](https://github.com/cubicdaiya/nginx-build) ⭐ 430 | 🐛 10 | 🌐 Go | 📅 2026-09-11 - seamless nginx builder.
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 5 | 🌐 Dockerfile | 📅 2026-09-15 - Latest Nginx with LuaJIT on six base distros (Alma, Alpine, Amazon, Debian, Fedora, Ubuntu).
