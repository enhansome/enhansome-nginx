...
* [OpenResty](https://github.com/openresty/ngx_openresty) ⭐ 14,035 | 🐛 336 | 🌐 C | 📅 2026-09-16
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,366 | 🐛 502 | 🌐 C | 📅 2026-09-07
* [Angie](https://github.com/webserver-llc/angie) ⭐ 2,568 | 🐛 44 | 🌐 C | 📅 2026-09-18
...
* [ngx\_openresty](https://github.com/openresty/ngx_openresty) ⭐ 14,035 | 🐛 336 | 🌐 C | 📅 2026-09-16 - Turning Nginx into a Full-fledged Web App Server.
* [nginx-rtmp-module](https://github.com/arut/nginx-rtmp-module) ⭐ 14,027 | 🐛 1,159 | 🌐 C | 📅 2024-12-24 - NGINX-based Media Streaming Server.
...
* [nginx-module-vts](https://github.com/vozlt/nginx-module-vts) ⭐ 3,503 | 🐛 11 | 🌐 C | 📅 2026-09-12 - Nginx virtual host traffic status module.
...
* [nginx\_modSecurity](https://github.com/SpiderLabs/ModSecurity-nginx) ⭐ 1,856 | 🐛 67 | 🌐 Perl | 📅 2026-05-04 - ModSecurity is an open source, cross platform web application firewall (WAF) engine for Apache, IIS and Nginx that is developed by Trustwave's SpiderLabs.
* [headers-more-nginx-module](https://github.com/openresty/headers-more-nginx-module) ⭐ 1,783 | 🐛 52 | 🌐 C | 📅 2026-09-16 - Set, add, and clear arbitrary output headers.
...
* [nginx-modsecurity](https://github.com/fabiocicerchia/nginx-modsecurity) ⭐ 0 | 🐛 4 | 🌐 Shell | 📅 2026-09-18 - ModSecurity v3 dynamic module for nginx as an artifact - a .so you load into your own nginx.
...
* [lua-resty-core](https://github.com/openresty/lua-resty-core) ⭐ 853 | 🐛 72 | 🌐 Lua | 📅 2026-09-16 - New FFI-based API for lua-nginx-module.
...
* [nginx-lua-waf-kit](https://github.com/fabiocicerchia/nginx-lua-waf-kit) ⭐ 1 | 🐛 6 | 🌐 Lua | 📅 2026-09-18 - Opt-in Lua WAF modules for nginx-lua: rate limiting, bot scoring, edge JWT, geo/ASN policy, mirroring.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,168 | 🐛 878 | 🌐 TypeScript | 📅 2026-09-14 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.
...
* [nginx-proxy](https://github.com/nginx-proxy/nginx-proxy) ⭐ 19,913 | 🐛 327 | 🌐 Python | 📅 2026-09-16 - Automated nginx proxy for Docker containers using docker-gen.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,974 | 🐛 173 | 🌐 Python | 📅 2026-09-18 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,345 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-18 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [nginx-opentracing](https://github.com/opentracing-contrib/nginx-opentracing) ⭐ 514 | 🐛 40 | 🌐 C++ | 📅 2026-09-18 - NGINX plugin for OpenTracing.
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 12 | 🌐 Dockerfile | 📅 2026-09-18 - Latest Nginx with LuaJIT on six base distros (Alma, Alpine, Amazon, Debian, Fedora, Ubuntu).
