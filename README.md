...
* [OpenResty](https://github.com/openresty/ngx_openresty) ⭐ 14,042 | 🐛 336 | 🌐 C | 📅 2026-09-21
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,370 | 🐛 502 | 🌐 C | 📅 2026-09-07
* [Angie](https://github.com/webserver-llc/angie) ⭐ 2,571 | 🐛 45 | 🌐 C | 📅 2026-09-18
...
* [ngx\_openresty](https://github.com/openresty/ngx_openresty) ⭐ 14,042 | 🐛 336 | 🌐 C | 📅 2026-09-21 - Turning Nginx into a Full-fledged Web App Server.
...
* [nginx\_modSecurity](https://github.com/SpiderLabs/ModSecurity-nginx) ⭐ 1,855 | 🐛 74 | 🌐 Perl | 📅 2026-09-19 - ModSecurity is an open source, cross platform web application firewall (WAF) engine for Apache, IIS and Nginx that is developed by Trustwave's SpiderLabs.
...
* [nginx-zstd-module](https://github.com/myguard-labs/nginx-zstd-module) ⭐ 33 | 🐛 7 | 🌐 C | 📅 2026-09-21 - Zstandard (zstd) compression and decompression filters for nginx responses.
...
* [nginx-autocert-module](https://github.com/myguard-labs/nginx-autocert-module) ⭐ 6 | 🐛 12 | 🌐 C | 📅 2026-09-21 - Automatic TLS certificates built into nginx — ACME/Let's Encrypt issuance and renewal, with wildcard, IP-address certs and TLS-ALPN-01.
...
* [nginx-modsecurity](https://github.com/fabiocicerchia/nginx-modsecurity) ⭐ 0 | 🐛 0 | 🌐 Shell | 📅 2026-09-21 - ModSecurity v3 dynamic module for nginx as an artifact - a .so you load into your own nginx.
...
* [nginx-lua-waf-kit](https://github.com/fabiocicerchia/nginx-lua-waf-kit) ⭐ 1 | 🐛 2 | 🌐 Lua | 📅 2026-09-21 - Opt-in Lua WAF modules for nginx-lua: rate limiting, bot scoring, edge JWT, geo/ASN policy, mirroring.
...
* [nginx-s3-gateway](https://github.com/nginxinc/nginx-s3-gateway) ⭐ 754 | 🐛 12 | 🌐 Shell | 📅 2026-09-21 - S3 gateway for Nginx allowing to proxy requests directly to S3 private buckets.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,194 | 🐛 876 | 🌐 TypeScript | 📅 2026-09-21 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.
...
* [nginx-proxy](https://github.com/nginx-proxy/nginx-proxy) ⭐ 19,914 | 🐛 329 | 🌐 Python | 📅 2026-09-21 - Automated nginx proxy for Docker containers using docker-gen.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,989 | 🐛 145 | 🌐 Python | 📅 2026-09-21 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,350 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-21 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [gixy-ng](https://github.com/dvershinin/gixy) ⭐ 1,183 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Nginx configuration static analyzer
...
* [nginx-build](https://github.com/cubicdaiya/nginx-build) ⭐ 430 | 🐛 12 | 🌐 Go | 📅 2026-09-20 - seamless nginx builder.
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 226 | 🐛 4 | 🌐 Dockerfile | 📅 2026-09-21 - Latest Nginx with LuaJIT on six base distros (Alma, Alpine, Amazon, Debian, Fedora, Ubuntu).
...
* [Nginx book](https://github.com/taobao/nginx-book) ⭐ 6,957 | 🐛 542 | 🌐 Python | 📅 2023-11-20 - Nginx from primer to expert (In Chinese).
