...
* [OpenResty](https://github.com/openresty/ngx_openresty) ⭐ 14,043 | 🐛 336 | 🌐 C | 📅 2026-09-21
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,372 | 🐛 502 | 🌐 C | 📅 2026-09-07
* [Angie](https://github.com/webserver-llc/angie) ⭐ 2,574 | 🐛 43 | 🌐 C | 📅 2026-09-23
...
* [ngx\_openresty](https://github.com/openresty/ngx_openresty) ⭐ 14,043 | 🐛 336 | 🌐 C | 📅 2026-09-21 - Turning Nginx into a Full-fledged Web App Server.
...
* [nginx-module-vts](https://github.com/vozlt/nginx-module-vts) ⭐ 3,504 | 🐛 11 | 🌐 C | 📅 2026-09-12 - Nginx virtual host traffic status module.
...
* [nginx-auth-ldap](https://github.com/kvspb/nginx-auth-ldap) ⭐ 760 | 🐛 150 | 🌐 C | 📅 2024-07-25 - LDAP authentication module for nginx.
...
* [nginx-cgi](https://github.com/pjincz/nginx-cgi) ⭐ 57 | 🐛 5 | 🌐 C | 📅 2026-09-22 - Module providing native CGI support, eliminating the need for fcgiwrap or other FastCGI adapters.
...
* [ngx-rust](https://github.com/nginxinc/ngx-rust) ⭐ 915 | 🐛 50 | 🌐 Rust | 📅 2026-09-18 - Rust bindings for Nginx modules.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,208 | 🐛 857 | 🌐 TypeScript | 📅 2026-09-23 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.

* [nginxconfig.io](https://nginxconfig.io) - [GitHub](https://github.com/valentinxxx/nginxconfig.io) ⭐ 28,252 | 🐛 71 | 🌐 JavaScript | 📅 2024-12-14 - Online nginx configuration generator for general purposes.
...
* [Laradock](https://github.com/laradock/laradock) ⭐ 12,675 | 🐛 23 | 🌐 Dockerfile | 📅 2026-09-10 - Full PHP development environment based on Docker, includes Nginx as one of its swappable services.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,996 | 🐛 152 | 🌐 Python | 📅 2026-09-23 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,351 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-23 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [gixy-ng](https://github.com/dvershinin/gixy) ⭐ 1,184 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Nginx configuration static analyzer
...
* [nginx-opentracing](https://github.com/opentracing-contrib/nginx-opentracing) ⭐ 513 | 🐛 40 | 🌐 C++ | 📅 2026-09-22 - NGINX plugin for OpenTracing.

* [puppet-nginx](https://github.com/jfryman/puppet-nginx) ⭐ 467 | 🐛 105 | 🌐 Ruby | 📅 2026-09-20 - Puppet Module to manage NGINX on various UNIXes.
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 226 | 🐛 5 | 🌐 Dockerfile | 📅 2026-09-23 - Latest Nginx with LuaJIT on six base distros (Alma, Alpine, Amazon, Debian, Fedora, Ubuntu).
