...
* [OpenResty](https://github.com/openresty/ngx_openresty) ⭐ 14,015 | 🐛 333 | 🌐 C | 📅 2026-08-24
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,340 | 🐛 501 | 🌐 C | 📅 2026-08-24
* [Angie](https://github.com/webserver-llc/angie) ⭐ 2,550 | 🐛 44 | 🌐 C | 📅 2026-08-26
...
* [ngx\_openresty](https://github.com/openresty/ngx_openresty) ⭐ 14,015 | 🐛 333 | 🌐 C | 📅 2026-08-24 - Turning Nginx into a Full-fledged Web App Server.
...
* [nginx\_modSecurity](https://github.com/SpiderLabs/ModSecurity-nginx) ⭐ 1,848 | 🐛 70 | 🌐 Perl | 📅 2026-05-04 - ModSecurity is an open source, cross platform web application firewall (WAF) engine for Apache, IIS and Nginx that is developed by Trustwave's SpiderLabs.
...
* [nginx-zstd-module](https://github.com/myguard-labs/nginx-zstd-module) ⭐ 28 | 🐛 5 | 🌐 C | 📅 2026-08-27 - Zstandard (zstd) compression and decompression filters for nginx responses.
...
* [nginx-cache-turbo-module](https://github.com/myguard-labs/nginx-cache-turbo-module) ⭐ 3 | 🐛 1 | 🌐 C | 📅 2026-08-27 - Built-in full-page cache for nginx — a tiny Varnish living inside the worker.
...
* [ngx-rust](https://github.com/nginxinc/ngx-rust) ⭐ 907 | 🐛 41 | 🌐 Rust | 📅 2026-08-21 - Rust bindings for Nginx modules.
...
* [nginx-s3-gateway](https://github.com/nginxinc/nginx-s3-gateway) ⭐ 748 | 🐛 16 | 🌐 Shell | 📅 2026-08-27 - S3 gateway for Nginx allowing to proxy requests directly to S3 private buckets.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,007 | 🐛 902 | 🌐 TypeScript | 📅 2026-08-26 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.
...
* [nginx-proxy](https://github.com/nginx-proxy/nginx-proxy) ⭐ 19,899 | 🐛 324 | 🌐 Python | 📅 2026-08-26 - Automated nginx proxy for Docker containers using docker-gen.

* [Laradock](https://github.com/laradock/laradock) ⭐ 12,672 | 🐛 16 | 🌐 Dockerfile | 📅 2026-08-16 - Full PHP development environment based on Docker, includes Nginx as one of its swappable services.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,870 | 🐛 164 | 🌐 Python | 📅 2026-08-27 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,294 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-27 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [nginx-build](https://github.com/cubicdaiya/nginx-build) ⭐ 427 | 🐛 10 | 🌐 Go | 📅 2026-08-27 - seamless nginx builder.
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 6 | 🌐 Dockerfile | 📅 2026-08-27 - Nginx 1.19+ with LUA support based on Alpine Linux, Amazon Linux, CentOS, Debian, Fedora and Ubuntu.
