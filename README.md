...
* [OpenResty](https://github.com/openresty/ngx_openresty) ⭐ 14,027 | 🐛 334 | 🌐 C | 📅 2026-09-02
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,347 | 🐛 502 | 🌐 C | 📅 2026-09-04
...
* [lua](https://github.com/openresty/lua-nginx-module) ⭐ 11,789 | 🐛 394 | 🌐 C | 📅 2026-08-24
...
* [ngx\_openresty](https://github.com/openresty/ngx_openresty) ⭐ 14,027 | 🐛 334 | 🌐 C | 📅 2026-09-02 - Turning Nginx into a Full-fledged Web App Server.
* [lua-nginx-module](https://github.com/openresty/lua-nginx-module) ⭐ 11,789 | 🐛 394 | 🌐 C | 📅 2026-08-24 - Embed the Power of Lua into NGINX.
...
* [nginx\_modSecurity](https://github.com/SpiderLabs/ModSecurity-nginx) ⭐ 1,854 | 🐛 70 | 🌐 Perl | 📅 2026-05-04 - ModSecurity is an open source, cross platform web application firewall (WAF) engine for Apache, IIS and Nginx that is developed by Trustwave's SpiderLabs.
...
* [nginx-autocert-module](https://github.com/myguard-labs/nginx-autocert-module) ⭐ 6 | 🐛 1 | 🌐 C | 📅 2026-09-06 - Automatic TLS certificates built into nginx — ACME/Let's Encrypt issuance and renewal, with wildcard, IP-address certs and TLS-ALPN-01.
...
* [nginx-lua-waf-kit](https://github.com/fabiocicerchia/nginx-lua-waf-kit) ⭐ 1 | 🐛 9 | 🌐 Lua | 📅 2026-09-06 - Opt-in Lua WAF modules for nginx-lua: rate limiting, bot scoring, edge JWT, geo/ASN policy, mirroring.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,077 | 🐛 893 | 🌐 TypeScript | 📅 2026-09-03 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.
...
* [nginx-proxy](https://github.com/nginx-proxy/nginx-proxy) ⭐ 19,906 | 🐛 326 | 🌐 Python | 📅 2026-09-03 - Automated nginx proxy for Docker containers using docker-gen.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,910 | 🐛 166 | 🌐 Python | 📅 2026-09-06 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,324 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-06 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [nginx-opentracing](https://github.com/opentracing-contrib/nginx-opentracing) ⭐ 515 | 🐛 40 | 🌐 C++ | 📅 2026-09-06 - NGINX plugin for OpenTracing.
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 10 | 🌐 Dockerfile | 📅 2026-09-06 - Latest Nginx with LuaJIT on six base distros (Alma, Alpine, Amazon, Debian, Fedora, Ubuntu).
