...
* [OpenResty](https://github.com/openresty/ngx_openresty) ⭐ 14,014 | 🐛 333 | 🌐 C | 📅 2026-08-24
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,341 | 🐛 501 | 🌐 C | 📅 2026-08-24
...
* [ngx\_openresty](https://github.com/openresty/ngx_openresty) ⭐ 14,014 | 🐛 333 | 🌐 C | 📅 2026-08-24 - Turning Nginx into a Full-fledged Web App Server.
...
* [nginx-zstd-module](https://github.com/myguard-labs/nginx-zstd-module) ⭐ 28 | 🐛 6 | 🌐 C | 📅 2026-08-27 - Zstandard (zstd) compression and decompression filters for nginx responses.
...
* [nginx-cache-turbo-module](https://github.com/myguard-labs/nginx-cache-turbo-module) ⭐ 3 | 🐛 0 | 🌐 C | 📅 2026-08-27 - Built-in full-page cache for nginx — a tiny Varnish living inside the worker.
...
* [nginx-s3-gateway](https://github.com/nginxinc/nginx-s3-gateway) ⭐ 748 | 🐛 13 | 🌐 Shell | 📅 2026-08-27 - S3 gateway for Nginx allowing to proxy requests directly to S3 private buckets.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 33,998 | 🐛 900 | 🌐 TypeScript | 📅 2026-08-26 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,868 | 🐛 162 | 🌐 Python | 📅 2026-08-27 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,293 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-27 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [nginx-build](https://github.com/cubicdaiya/nginx-build) ⭐ 427 | 🐛 9 | 🌐 Go | 📅 2026-08-26 - seamless nginx builder.
