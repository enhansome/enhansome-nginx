...
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,332 | 🐛 499 | 🌐 C | 📅 2026-08-12
...
* [nginx-rtmp-module](https://github.com/arut/nginx-rtmp-module) ⭐ 14,030 | 🐛 1,160 | 🌐 C | 📅 2024-12-24 - NGINX-based Media Streaming Server.
* [ngx\_openresty](https://github.com/openresty/ngx_openresty) ⭐ 14,002 | 🐛 332 | 🌐 C | 📅 2026-08-14 - Turning Nginx into a Full-fledged Web App Server.
...
* [nginx-module-vts](https://github.com/vozlt/nginx-module-vts) ⭐ 3,500 | 🐛 9 | 🌐 C | 📅 2026-08-16 - Nginx virtual host traffic status module.
...
* [headers-more-nginx-module](https://github.com/openresty/headers-more-nginx-module) ⭐ 1,783 | 🐛 53 | 🌐 C | 📅 2026-07-17 - Set, add, and clear arbitrary output headers.
...
* [nginx-cache-turbo-module](https://github.com/myguard-labs/nginx-cache-turbo-module) ⭐ 3 | 🐛 0 | 🌐 C | 📅 2026-08-17 - Built-in full-page cache for nginx — a tiny Varnish living inside the worker.
...
* [lua-resty-http](https://github.com/pintsized/lua-resty-http) ⭐ 2,079 | 🐛 42 | 🌐 Lua | 📅 2026-08-11 - Lua HTTP client cosocket driver for OpenResty / ngx\_lua.
...
* [lua-resty-websocket](https://github.com/openresty/lua-resty-websocket) ⭐ 523 | 🐛 32 | 🌐 Lua | 📅 2026-08-17 - WebSocket support for the ngx\_lua module (and OpenResty).
...
* [nginx-s3-gateway](https://github.com/nginxinc/nginx-s3-gateway) ⭐ 742 | 🐛 67 | 🌐 JavaScript | 📅 2026-08-15 - S3 gateway for Nginx allowing to proxy requests directly to S3 private buckets.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 33,882 | 🐛 926 | 🌐 TypeScript | 📅 2026-08-12 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.
...
* [nginx-proxy](https://github.com/nginx-proxy/nginx-proxy) ⭐ 19,894 | 🐛 323 | 🌐 Python | 📅 2026-08-10 - Automated nginx proxy for Docker containers using docker-gen.

* [Laradock](https://github.com/laradock/laradock) ⭐ 12,662 | 🐛 14 | 🌐 Dockerfile | 📅 2026-08-16 - Full PHP development environment based on Docker, includes Nginx as one of its swappable services.
...
* [bunkerized-nginx](https://github.com/bunkerity/bunkerized-nginx) ⭐ 10,820 | 🐛 183 | 🌐 Python | 📅 2026-08-17 - nginx Docker image secure by default.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,275 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-17 - Docker container for managing Nginx proxy hosts with a simple, powerful interface

* [nginx-conf](https://github.com/lebinh/nginx-conf) ⭐ 2,117 | 🐛 2 | 📅 2017-10-13 - A collection of useful Nginx configuration snippets.
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 9 | 🌐 Dockerfile | 📅 2026-08-17 - Nginx 1.19+ with LUA support based on Alpine Linux, Amazon Linux, CentOS, Debian, Fedora and Ubuntu.
