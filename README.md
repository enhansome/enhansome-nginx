...
* [OpenResty](https://github.com/openresty/ngx_openresty) ⭐ 14,029 | 🐛 335 | 🌐 C | 📅 2026-09-02
* [Tengine](https://github.com/alibaba/tengine) ⭐ 13,356 | 🐛 501 | 🌐 C | 📅 2026-09-07
* [Angie](https://github.com/webserver-llc/angie) ⭐ 2,566 | 🐛 45 | 🌐 C | 📅 2026-09-10
...
* [ngx\_openresty](https://github.com/openresty/ngx_openresty) ⭐ 14,029 | 🐛 335 | 🌐 C | 📅 2026-09-02 - Turning Nginx into a Full-fledged Web App Server.
...
* [nginx-zstd-module](https://github.com/myguard-labs/nginx-zstd-module) ⭐ 31 | 🐛 8 | 🌐 C | 📅 2026-09-04 - Zstandard (zstd) compression and decompression filters for nginx responses.
...
* [nginx-lua-waf-kit](https://github.com/fabiocicerchia/nginx-lua-waf-kit) ⭐ 1 | 🐛 3 | 🌐 Lua | 📅 2026-09-10 - Opt-in Lua WAF modules for nginx-lua: rate limiting, bot scoring, edge JWT, geo/ASN policy, mirroring.
...
* [nginx-proxy-manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,113 | 🐛 885 | 🌐 TypeScript | 📅 2026-09-09 - Webinterface to manage nginx reverse-proxys with Letsencrypt support.
...
* [Laradock](https://github.com/laradock/laradock) ⭐ 12,674 | 🐛 21 | 🌐 Dockerfile | 📅 2026-09-10 - Full PHP development environment based on Docker, includes Nginx as one of its swappable services.
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,930 | 🐛 168 | 🌐 Python | 📅 2026-09-10 - Open-source Web Application Firewall and reverse proxy based on NGINX.
...
* [NPMplus](https://github.com/ZoeyVid/NPMplus) ⭐ 2,329 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-10 - Docker container for managing Nginx proxy hosts with a simple, powerful interface
...
* [nginx-lua](https://github.com/fabiocicerchia/nginx-lua) ⭐ 225 | 🐛 8 | 🌐 Dockerfile | 📅 2026-09-10 - Latest Nginx with LuaJIT on six base distros (Alma, Alpine, Amazon, Debian, Fedora, Ubuntu).
